...
public interface ArticleService extends IService<Article> {
    ...
    Result getArticleList(String token);

    Result getArticleByArticleId(String articleId, String token);

    Result getArticleListByPalteId(String palteId, String token);
    ...
    Result updateArticle(Article article, Body body, List<String> tagsIdList);
    boolean deleteByUserId(String userId);
    boolean deleteByUserId(String userId, TransactionStatus transactionStatus);

    Result getArticleByCateory(String modularsId, String categoryId, Long page, Long pageSize);
    Result getArticleListByStatus(String status, String token);

    Result getArticleListByPalteIdAndStatus(String palteId, String status, String token);
}
