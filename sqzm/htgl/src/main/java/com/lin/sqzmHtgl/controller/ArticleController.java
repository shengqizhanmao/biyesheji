...
public class ArticleController {
    ...
    //修改帖子
    @PutMapping("/update")
    public Result update(@RequestBody UpdateArticle updateArticle) {
        Article article = new Article();
        BeanUtils.copyProperties(updateArticle,article);
        Body body = updateArticle.getBody();
        List<String> tagsIdList = updateArticle.getTagsIdList();
        return articleService.updateArticle(article, body, tagsIdList);
    }
