...
import com.lin.sqzmYxlt.controller.webSocketParam.WebSocketGetMeg;
import com.lin.sqzmYxlt.controller.webSocketParam.WebSocketPushMeg;
...
//                "连接webSocket,当前在线人数为" + webSocketSet.size());
    ...
    public void onMessage(String message, Session session,
        ...
        if (webSocketGetMeg.getType().equals("heartbeat")) {
            ...
            webSocketPushMeg.setMsg("心跳测试成功");
